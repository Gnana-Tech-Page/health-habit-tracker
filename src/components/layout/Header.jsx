...
import { Bell, Menu, User, KeyRound, LogOut, Activity } from 'lucide-react'
...
export default function Header({ onMenuToggle }) {
  ...
  return (
    <header className="h-16 bg-slate-800 border-b border-slate-700 flex items-center px-4 lg:px-6 gap-3 sticky top-0 z-30">
      ...
      <button className="text-slate-400 hover:text-slate-200 p-2 rounded-lg hover:bg-slate-700 transition-colors">
        <Bell size={18} />
      </button>
      ...
      <div className="relative" ref={ref}>
        ...
        {dropOpen && (
          <div className="absolute right-0 top-full mt-2 w-52 bg-slate-800 border border-slate-700 rounded-xl shadow-2xl shadow-black/40 py-1 z-50 animate-fade-in">
