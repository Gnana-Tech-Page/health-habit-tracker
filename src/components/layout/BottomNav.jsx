...
export default function BottomNav() {
  ...
  const base = 'flex flex-col items-center gap-0.5 px-3 py-2 text-xs font-medium transition-colors'
  const active   = 'text-sky-400'
  const inactive = 'text-slate-500 hover:text-slate-300'
  return (
    <nav className="lg:hidden fixed bottom-0 left-0 right-0 bg-slate-800 border-t border-slate-700 flex justify-around z-30 pb-safe">
